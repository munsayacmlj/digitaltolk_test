...
class BookingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // from the original code, it's only either a superadmin/admin or a user with user_id. Otherwise, the code will throw an error saying $response is undefined.
    ...
    public function distanceFeed(Request $request)
    {
        ...
        // Why are we using "true" as string instead of true as boolean?
        if ($data['flagged']) {
        ...
        $flagged = !empty($data['session_time']) ? $data['session_time'] : '';
        $manually_handled = !!$data['manually_handled'];
